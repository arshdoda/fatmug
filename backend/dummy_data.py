...
from apps.po.models import PO, Status
...
for i in range(1, 100001):
    ...
    acknowledgment_date = [issue_date + timezone.timedelta(days=random.randint(2,60)), None] 
    ...
    p = {"vendor":random.choice(vendor_list), "order_date": order_date, 
         ...
         "items":items, "quantity":random.randint(1,3), "status":random.choice(list(Status)), "quality_rating":random.randint(1,5),
